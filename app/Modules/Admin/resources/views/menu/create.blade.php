            ...
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-md-12">
                        {!! Form::label('parent_id', trans('Admin::qa.menus-create-parent')) !!}
                        {!! Form::select('parent_id', $parentsSelect, old('parent_id'), ['class'=>'form-control']) !!}
                    </div>

                    <div class="form-group col-md-12">
                        {!! Form::label('singular_name',  trans('Admin::qa.menus-create-singular_name')) !!}
                    ...
                    <div class="form-group col-md-12">
                        {!! Form::label('plural_name',  trans('Admin::qa.menus-create-plural_name')) !!}
                    ...
                    <div class="form-group col-md-12">
                        {!! Form::label('icon',  trans('Admin::qa.menus-create-icon')) !!}
